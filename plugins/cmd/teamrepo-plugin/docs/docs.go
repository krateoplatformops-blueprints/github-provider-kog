...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/collaborator.Permission"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/collaborator.Message"
                        }
                    },
                    "204": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/collaborator.RepoPermissions"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/cmd_teamrepo-plugin_handlers.TeamRepoPermissions"
                        }
                    }
                }
            }
    ...
    "definitions": {
        "cmd_teamrepo-plugin_handlers.TeamRepoPermissions": {
            "type": "object",
            "properties": {
                "allow_auto_merge": {
                    "type": "boolean"
        ...
        "collaborator.RepoPermissions": {
            ...
            "properties": {
                ...
                "permissions": {
                    "$ref": "#/definitions/collaborator.Permissions"
                },
                "role_name": {
                    "type": "string"
                },
                "user": {
                    "$ref": "#/definitions/collaborator.User"
                }
            }
        },
        "collaborator.User": {
