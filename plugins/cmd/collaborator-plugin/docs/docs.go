...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cmd_collaborator-plugin_handlers.Permission"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/cmd_collaborator-plugin_handlers.Message"
                        }
                    },
                    "204": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/cmd_collaborator-plugin_handlers.RepoPermissions"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/teamrepo.TeamRepoPermissions"
                        }
                    }
                }
            }
    ...
    "definitions": {
        "cmd_collaborator-plugin_handlers.Message": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
        ...
        "cmd_collaborator-plugin_handlers.Permission": {
            "type": "object",
            "properties": {
                "permission": {
                    "type": "string"
        ...
        "cmd_collaborator-plugin_handlers.Permissions": {
            "type": "object",
            "properties": {
                "admin": {
                    "type": "boolean"
        ...
        "cmd_collaborator-plugin_handlers.RepoPermissions": {
            "type": "object",
            "properties": {
                "html_url": {
                    "type": "string"
                ...
                "permissions": {
                    "$ref": "#/definitions/cmd_collaborator-plugin_handlers.Permissions"
                },
                "role_name": {
                    "type": "string"
                },
                "user": {
                    "$ref": "#/definitions/cmd_collaborator-plugin_handlers.User"
                }
            }
        },
        "cmd_collaborator-plugin_handlers.User": {
            "type": "object",
            "properties": {
                "avatar_url": {
                    "type": "string"
...
var SwaggerInfo = &swag.Spec{
	...
	BasePath:         "/",
	Schemes:          []string{"http"},
	Title:            "GitHub Collaborator Plugin API",
	Description:      "A service for managing GitHub repository collaborators and invitations.",
